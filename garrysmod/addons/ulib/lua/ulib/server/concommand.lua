...
--[[
	...
	Parameters:
		...
		say_cmd - A command string for says. IE: "not kick", then when someone says "not kick", it'll call the callback.
		...
		nospace - *(Optional, defaults to false)* If true, a space won't be required after the command "IE: not slapbob" vs "not slap bob".
