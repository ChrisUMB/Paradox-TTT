...
local vote = ulx.command( CATEGORY_NAME, "ulx vote", ulx.vote, "not vote" )
...
local stopvote = ulx.command( CATEGORY_NAME, "ulx stopvote", ulx.stopVote, "not stopvote" )
...
local votemap2 = ulx.command( CATEGORY_NAME, "ulx votemap2", ulx.votemap2, "not votemap2" )
...
local votekick = ulx.command( CATEGORY_NAME, "ulx votekick", ulx.votekick, "not votekick" )
...
local voteban = ulx.command( CATEGORY_NAME, "ulx voteban", ulx.voteban, "not voteban" )
...
local votemap = ulx.command( CATEGORY_NAME, "ulx votemap", ulx.votemap, "not votemap" )
...
-- Our veto command
local veto = ulx.command( CATEGORY_NAME, "ulx veto", ulx.votemapVeto, "not veto" )
