...
local bring = ulx.command( CATEGORY_NAME, "ulx bring", ulx.bring, "not bring" )
...
local goto = ulx.command( CATEGORY_NAME, "ulx goto", ulx.goto, "not goto" )
...
local send = ulx.command( CATEGORY_NAME, "ulx send", ulx.send, "not send" )
...
local teleport = ulx.command( CATEGORY_NAME, "ulx teleport", ulx.teleport, {"not tp", "not teleport"} )
...
local retrn = ulx.command( CATEGORY_NAME, "ulx return", ulx.retrn, "not return" )
