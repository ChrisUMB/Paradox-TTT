...
local slap = ulx.command( CATEGORY_NAME, "ulx slap", ulx.slap, "not slap" )
...
local whip = ulx.command( CATEGORY_NAME, "ulx whip", ulx.whip, "not whip" )
...
local slay = ulx.command( CATEGORY_NAME, "ulx slay", ulx.slay, "not slay" )
...
local sslay = ulx.command( CATEGORY_NAME, "ulx sslay", ulx.sslay, "not sslay" )
...
local ignite = ulx.command( CATEGORY_NAME, "ulx ignite", ulx.ignite, "not ignite" )
...
ignite:setOpposite( "ulx unignite", {_, _, _, true}, "not unignite" )
...
local unigniteall = ulx.command( CATEGORY_NAME, "ulx unigniteall", ulx.unigniteall, "not unigniteall" )
...
local freeze = ulx.command( CATEGORY_NAME, "ulx freeze", ulx.freeze, "not freeze" )
...
freeze:setOpposite( "ulx unfreeze", {_, _, true}, "not unfreeze" )
...
local god = ulx.command( CATEGORY_NAME, "ulx god", ulx.god, "not god" )
...
god:setOpposite( "ulx ungod", {_, _, true}, "not ungod" )
...
local hp = ulx.command( CATEGORY_NAME, "ulx hp", ulx.hp, "not hp" )
...
local armor = ulx.command( CATEGORY_NAME, "ulx armor", ulx.armor, "not armor" )
...
local cloak = ulx.command( CATEGORY_NAME, "ulx cloak", ulx.cloak, "not cloak" )
...
cloak:setOpposite( "ulx uncloak", {_, _, _, true}, "not uncloak" )
...
local blind = ulx.command( CATEGORY_NAME, "ulx blind", ulx.blind, "not blind" )
...
blind:setOpposite( "ulx unblind", {_, _, _, true}, "not unblind" )
...
local jail = ulx.command( CATEGORY_NAME, "ulx jail", ulx.jail, "not jail" )
...
jail:setOpposite( "ulx unjail", {_, _, _, true}, "not unjail" )
...
local jailtp = ulx.command( CATEGORY_NAME, "ulx jailtp", ulx.jailtp, "not jailtp" )
...
local ragdoll = ulx.command( CATEGORY_NAME, "ulx ragdoll", ulx.ragdoll, "not ragdoll" )
...
ragdoll:setOpposite( "ulx unragdoll", {_, _, true}, "not unragdoll" )
...
local maul = ulx.command( CATEGORY_NAME, "ulx maul", ulx.maul, "not maul" )
...
local strip = ulx.command( CATEGORY_NAME, "ulx strip", ulx.stripweapons, "not strip" )
