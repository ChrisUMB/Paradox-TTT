...
local rcon = ulx.command( CATEGORY_NAME, "ulx rcon", ulx.rcon, "not rcon", true, false, true )
...
local cexec = ulx.command( CATEGORY_NAME, "ulx cexec", ulx.cexec, "not cexec", false, false, true )
