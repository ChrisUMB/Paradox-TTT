...
local version = ulx.command( CATEGORY_NAME, "ulx version", ulx.versionCmd, "not version" )
...
local map = ulx.command( CATEGORY_NAME, "ulx map", ulx.map, "not map" )
...
local kick = ulx.command( CATEGORY_NAME, "ulx kick", ulx.kick, "not kick" )
...
local ban = ulx.command( CATEGORY_NAME, "ulx ban", ulx.ban, "not ban", false, false, true )
...
local noclip = ulx.command( CATEGORY_NAME, "ulx noclip", ulx.noclip, "not noclip" )
...
local spectate = ulx.command( CATEGORY_NAME, "ulx spectate", ulx.spectate, "not spectate", true )
