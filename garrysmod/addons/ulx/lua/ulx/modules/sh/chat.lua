...
local psay = ulx.command( CATEGORY_NAME, "ulx psay", ulx.psay, "not p", true )
...
local thetime = ulx.command( CATEGORY_NAME, "ulx thetime", ulx.thetime, "not thetime" )
...
local gimp = ulx.command( CATEGORY_NAME, "ulx gimp", ulx.gimp, "not gimp" )
...
gimp:setOpposite( "ulx ungimp", {_, _, true}, "not ungimp" )
...
local mute = ulx.command( CATEGORY_NAME, "ulx mute", ulx.mute, "not mute" )
...
mute:setOpposite( "ulx unmute", {_, _, true}, "not unmute" )
...
local gag = ulx.command( CATEGORY_NAME, "ulx gag", ulx.gag, "not gag" )
...
gag:setOpposite( "ulx ungag", {_, _, true}, "not ungag" )
