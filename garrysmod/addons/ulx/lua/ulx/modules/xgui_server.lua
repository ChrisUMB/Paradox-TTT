...
function xgui.init()
	...
	ULib.addSayCommand( "not xgui", xgui_chatCommand )
	ULib.addSayCommand( "not menu", xgui_chatCommand )
	...
	ulx.addToHelpManually( "Menus", "xgui", "<show, hide, toggle> - Opens and/or closes XGUI. (say: not xgui, not menu) (alias: ulx menu)" )
end
