if CLIENT then
    SWEP.WepSelectIcon = surface.GetTextureID("pwb2/vgui/weapons/ace23")
    SWEP.DrawWeaponInfoBox = false
    SWEP.BounceWeaponIcon = false
    killicon.Add("weapon_pwb2_ace23", "pwb2/vgui/weapons/ace23", Color(255, 255, 255, 255))
end

SWEP.PrintName = "ACE 23"
SWEP.Category = "PWB 2"
...
SWEP.ViewModel = "models/pwb2/weapons/v_ace23.mdl"
...
SWEP.Primary.Sound = Sound("Weapon_PWB2_ACE23.Single")
...
SWEP.Equip = function(self)
    return OverrideEquip(self)
end
