if CLIENT then
    SWEP.WepSelectIcon = surface.GetTextureID("pwb2/vgui/weapons/g36c")
    SWEP.DrawWeaponInfoBox = false
    SWEP.BounceWeaponIcon = false
    killicon.Add("weapon_pwb2_g36c", "pwb2/vgui/weapons/g36c", Color(255, 255, 255, 255))
end
...
SWEP.ViewModel = "models/pwb2/weapons/v_g36c.mdl"
SWEP.WorldModel = "models/pwb2/weapons/w_g36c.mdl"
...
SWEP.Primary.Sound = Sound("Weapon_PWB2_G36C.Single")
