if CLIENT then
    SWEP.WepSelectIcon = surface.GetTextureID("pwb2/vgui/weapons/pl14")
    SWEP.DrawWeaponInfoBox = false
    SWEP.BounceWeaponIcon = false
    killicon.Add("weapon_pwb2_pl14", "pwb2/vgui/weapons/pl14", Color(255, 255, 255, 255))
end
...
SWEP.ViewModel = "models/pwb2/weapons/v_pl14.mdl"
...
SWEP.Primary.Sound = Sound("Weapon_PWB2_PL14.Single")
