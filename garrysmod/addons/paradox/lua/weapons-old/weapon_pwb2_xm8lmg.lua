if CLIENT then
    SWEP.WepSelectIcon = surface.GetTextureID("pwb2/vgui/weapons/xm8lmg")
    SWEP.DrawWeaponInfoBox = false
    SWEP.BounceWeaponIcon = false
    killicon.Add("weapon_pwb2_xm8lmg", "pwb2/vgui/weapons/xm8lmg", Color(255, 255, 255, 255))
end
...
SWEP.ViewModel = "models/pwb2/weapons/v_xm8lmg.mdl"
...
SWEP.Primary.Sound = Sound("Weapon_PWB2_XM8LMG.Single")
...
function SWEP:Think()
    ...
    if self.ReloadingTimer >= CurTime() + 3.75 then
    self.Owner:ViewPunch( Angle(-0.015, 0, 0))
    end
    ...
    self.Owner:ViewPunch(Angle( -0.025, 0, -0.025))
    end
