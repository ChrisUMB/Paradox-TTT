if CLIENT then
    SWEP.WepSelectIcon = surface.GetTextureID("pwb2/vgui/weapons/m60")
    SWEP.DrawWeaponInfoBox = false
    SWEP.BounceWeaponIcon = false
    killicon.Add("weapon_pwb2_m60", "pwb2/vgui/weapons/m60", Color(255, 255, 255, 255))
end
...
SWEP.ViewModel = "models/pwb2/weapons/v_m60.mdl"
...
SWEP.Primary.Sound = Sound("Weapon_PWB2_M60.Single")
...
function SWEP:Think()
    ...
    if self.ReloadingTimer >= CurTime() + 4.5 then
