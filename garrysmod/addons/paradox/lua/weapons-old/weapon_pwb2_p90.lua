if CLIENT then
    SWEP.WepSelectIcon = surface.GetTextureID("pwb2/vgui/weapons/p90")
    SWEP.DrawWeaponInfoBox = false
    SWEP.BounceWeaponIcon = false
    killicon.Add("weapon_pwb2_p90", "pwb2/vgui/weapons/p90", Color(255, 255, 255, 255))
end
...
SWEP.ViewModel = "models/pwb2/weapons/v_p90.mdl"
...
SWEP.Primary.Sound = Sound("Weapon_PWB2_P90.Single")
