if CLIENT then
    SWEP.WepSelectIcon = surface.GetTextureID("pwb2/vgui/weapons/m4super90")
    SWEP.DrawWeaponInfoBox = false
    SWEP.BounceWeaponIcon = false
    killicon.Add("weapon_pwb2_m4super90", "pwb2/vgui/weapons/m4super90", Color(255, 255, 255, 255))
end
...
SWEP.Primary.Sound = Sound("Weapon_PWB2_M4Super90.Single")
