if CLIENT then
    SWEP.WepSelectIcon = surface.GetTextureID("pwb2/vgui/weapons/mp7")
    SWEP.DrawWeaponInfoBox = false
    SWEP.BounceWeaponIcon = false
    killicon.Add("weapon_pwb2_mp7", "pwb2/vgui/weapons/mp7", Color(255, 255, 255, 255))
end
...
SWEP.ViewModel = "models/pwb2/weapons/v_mp7.mdl"
...
SWEP.Primary.Sound = Sound("Weapon_PWB2_mp7.Single")
