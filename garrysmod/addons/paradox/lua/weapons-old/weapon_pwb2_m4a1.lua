if CLIENT then
    SWEP.WepSelectIcon = surface.GetTextureID("pwb2/vgui/weapons/m4a1")
    SWEP.DrawWeaponInfoBox = false
    SWEP.BounceWeaponIcon = false
    killicon.Add("weapon_pwb2_m4a1", "pwb2/vgui/weapons/m4a1", Color(255, 255, 255, 255))
end
...
SWEP.ViewModel = "models/pwb2/weapons/v_m4a1.mdl"
...
SWEP.Primary.Sound = Sound("Weapon_PWB2_M4A1.Single")
