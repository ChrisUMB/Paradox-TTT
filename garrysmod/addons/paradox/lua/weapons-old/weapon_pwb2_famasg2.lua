if CLIENT then
    SWEP.WepSelectIcon = surface.GetTextureID("pwb2/vgui/weapons/famasg2")
    SWEP.DrawWeaponInfoBox = false
    SWEP.BounceWeaponIcon = false
    killicon.Add("weapon_pwb2_famasg2", "pwb2/vgui/weapons/famasg2", Color(255, 255, 255, 255))
end
...
SWEP.ViewModel = "models/pwb2/weapons/v_famasg2.mdl"
...
SWEP.Primary.Sound = Sound("Weapon_PWB2_FAMASG2.Single")
